...
class ContrastiveLossFG(nn.Module):
    ...
    def con_loss(self,features, labels):
                    ...
                    #se obtiene un tensor por cada batch y si es verdadero o no respecto su batch
                    #es decir, si la primera imagen es 1 se obtiene un tensor comprobando si las demás es la misma etiqueta
